...
% Alex Pfankuch and Ben Taylor 29 and 15
...
% tables represents a different configuration from the Design Input
...
% Note that once a drag polar model is selected for use in your design, you
