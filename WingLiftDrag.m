...
% /////////////////////////////////////////////////////////////////////////
    ...
    Cl(1)= a(n);
    WingLiftCurve(n,:) = Cl(1).*(AoA-AoA_0(n)); % Evaluate the 3D coefficient of lift values at AoA's in array (AoA) definied above

    % 3D Wing Drag Coefficient
    WingDragCurve(n,:) = (WingLiftCurve(n,:).^2)./(pi*e(n)* Design_Input.AR_w(n))+Airfoil{n,(24:41)}; % Just the 3D coefficient of drag values at AoA's in array (AoA) definied above
% /////////////////////////////////////////////////////////////////////////
