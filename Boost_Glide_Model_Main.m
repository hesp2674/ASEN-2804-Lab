...
[GlideRange_bench] = GlideDescent(LD_benchmark, apogee, Design_Input, ATMOS, Weight_Data, WingLiftModel, WingLiftCurve, Count);
[GlideRange_mod1] = GlideDescent(LD_mod1, apogee, Design_Input, ATMOS, Weight_Data, WingLiftModel, WingLiftCurve, Count);
[GlideRange_mod2] = GlideDescent(LD_mod2, apogee, Design_Input, ATMOS, Weight_Data, WingLiftModel, WingLiftCurve, Count); 
[GlideRange_mod3] = GlideDescent(LD_mod3, apogee, Design_Input, ATMOS, Weight_Data, WingLiftModel, WingLiftCurve, Count);
